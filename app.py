...
# एआई模型 सेटअप (जेम्स मैनेजर की तरह लाइव सर्च के साथ)
...
# ==============================================================================
# ✨ PREMIUM BLACK & ORANGE THEME (ब्यूटीफुल लुक सीएसएस) ✨
# ==============================================================================
...
# लोगो और हेडर दिखाने का सुंदर तरीका
def show_header():
...
if not st.session_state.logged_in:
    ...
    st.write("")
    show_header()
    st.markdown("<h3 style='text-align: center; color: #ffffff; margin-top: 0;'>Welcome to <span class='orange-text'>BULLOPEDIA</span></h3>", unsafe_allow_html=True)
    ...
    # मुख्य लाइव fundamental पोर्टल स्क्रीन
    ...
    if analyze_button:
        if stock_name.strip() == "":
            ...
            with st.spinner(f"🔍 Crawling live data streams and analyzing {stock_name}, please hold..."):
                try:
                    response = model.generate_content(f"Analyze this Indian stock completely using live search data and strictly follow your system template instructions: {stock_name}")
